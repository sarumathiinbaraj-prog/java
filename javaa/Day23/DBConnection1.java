...
//                  //(j to //)comman hostname:port/databasename
...
// }
//run terminal
//javac -cp " .;lib/mysql-connector-j-9.6.0.jar" DBConnection1.java
//java -cp " .;lib/mysql-connector-j-9.6.0.jar" DBConnection1
...
public class DBConnection1 {
    ...
    static final String PASSWORD = "Saru@2005";
